...
type AutomaticJunkFlags struct {
	...
	NeutralMailboxRegexp string `sconf:"optional" sconf-doc:"Example: ^(inbox|introbox|neutral|postmaster|dmarc|tlsrpt|rejects), and you may wish to add trash depending on how you use it, or leave this empty."`
